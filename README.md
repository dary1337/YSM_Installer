...
## What it does
Few-click installer for **YSM**, **YSM x WiF**, and **YSM x WTO**. Finds your game, picks the right mod version, installs it safely, and leaves your save/config untouched.
...
- **Cancel anytime** — the progress bar has a Cancel button. Cancelling restores the previous state.
- **Clear errors** — if the installer can't reach the internet, it tells you whether you're offline, GitHub is down, or just the mod list is broken, instead of a cryptic error.
...
- download the mod archive you chose
