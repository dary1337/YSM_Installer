...
namespace YSMInstaller
{
    internal static class DevWarnoMocks
    {
        public static bool IsEnabled
        {
            ...
            {
#if DEBUG
                return DevService.IsMockWarnoPathsEnabled;
#else
                return false;
#endif
            }
        ...
        private static List<ModMetadata> CreateSupportedMods()
        {
            return new List<ModMetadata>
            {
                new ModMetadata
                {
                    ...
                    KnownIssuesUrl = "https://steamcommunity.com/workshop/filedetails/discussion/3296415395/4509876644765422685/"
                },
                new ModMetadata
                {
                    ModType = ModTypes.Ysm,
        ...
        private static List<WarnoEntry> CreateEntries(List<ModMetadata> supportedMods)
        {
            ...
            {
                CreateEntry(@"C:\Games\WARNO\Warno.exe", 188908, "Mock Steam", supportedMods, latestSupportedVersion),
                CreateEntry(@"D:\SteamLibrary\steamapps\common\WARNO\Warno.exe", 200000, "Mock future version", supportedMods, latestSupportedVersion),
                CreateEntry(@"E:\Portable\WARNO\Warno.exe", 146198, "Mock known issues", supportedMods, latestSupportedVersion),
                CreateEntry(@"F:\OldGames\WARNO\Warno.exe", 120000, "Mock unsupported", supportedMods, latestSupportedVersion)
            };
        }
        ...
        )
        {
            return new WarnoEntry
            {
                ...
                LatestCompatibleModVersion = version > latestSupportedVersion
